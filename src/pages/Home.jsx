...
const {weather,time,localTimeDate,
  ...
  return (
    ...
    <div className=' flex  flex-col w-full h-full overflow-x-scroll p-5 pb-32 text-white'>
        ...
        <RiMenuUnfoldFill onClick={() => setManuber(!manuber)} className=' sideberandlocationtrack size-11 border-1 border-black/20 p-2 rounded-md text-violet-700 hover:scale-105 cursor-pointer'/>
        ...
        <div className=" mainpart relative flex flex-col w-full min-h-50 max-h-55 h-fit pb-4 mt-15 rounded-3xl  bg-gradient-to-bl from-violet-400 to-violet-600 hover:scale-101 cursor-pointer">
