    ...
    <div className="flex flex-col w-full h-fit ">
      ...
      >
        ...
        >
          ...
          >
            <div
              className={`flex absolute w-20 h-5 ${
                theme === true ? " bg-white" : " bg-zinc-800"
          ...
          <div className="absolute flex flex-col items-center  left-7">
            Sunrise
            <div className="">
              {new Date(
          ...
          <div className="absolute flex flex-col items-center right-7">
            Sunset
            <div className=""></div>
            {new Date(
      ...
      <NavLink
        to={"/forecast"}
        className="flex justify-center items-center mt-20 w-full h-fit"
      >
        <div
          className={`flex items-center justify-center flex-row lg:w-[50%] w-full h-12 rounded-2xl text-xl gap-1 ${
            theme === true ? "bg-violet-500/50" : "bg-zinc-600"
          } shadow-md shadow-black/60 `}
        >
          <p>Forecast Data </p>
          <FaAngleDoubleRight className="size-6 animate-pulse" />
        </div>
      </NavLink>
    </div>
  );
