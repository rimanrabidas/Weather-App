...
return(
    <BioContext.Provider value={{weather,setWeather,city,setCity,error,setError,forecastWeather,setForecastWeather,dailyForecastWeather, setDailyForecastWeather,loading,setLoading,handleSearch,inputCity,setInputCity,setTheme,theme,history,setHistory,suggestions,setSuggestions,searchError,setSearchError}}>
        {children}
    </BioContext.Provider>
)
